...
## Application
 ...
 - The second half of the mentioned assignment was to develop a web application. The application was named ***MPG Prediction***. An instance is up & running at <https://skmsourav.shinyapps.io/RandomForest/>.
 ...
 - The application and the current presentation source codes can be found at <https://github.com/skmsourav/DevelopingDataProducts>. The application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *model.R* (Random Forest predictor).
